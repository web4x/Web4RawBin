// [test:uuid:PENDING-req-mint] r41-1 file render-proof — the pixel gate for File.renderSelf (Method 3feca893 / UC file.renderSelf 59649d58): AC1 SVG-glyph-consistent · AC2 NAME==model.name/title (not uuid) · AC4 uuid-fallback ONLY on genuine name+title absence. ★ req to MINT the Test unit + wire this marker (expert does not self-mint Tests). Strengthened both-directions + AC4 (80→0 wrong-fallback) on v0.8.237.
