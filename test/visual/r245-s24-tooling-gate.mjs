...
if (!green) console.log(knownBrokenBanner('r245-s24-tooling-gate')); // R37.28/T37.32 mark-not-silence: this RED is tracked gate-invocation infra, NOT a product regression
