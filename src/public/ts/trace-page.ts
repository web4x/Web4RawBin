...
// BUG5 instrumentation — KEEP until GREEN
...
document.addEventListener('touchend', (e) => {
  const t = e.target as HTMLElement;
  console.log('TOUCH', t.tagName, t.className || '', 'drawer:' + !!t.closest('rb-detail-drawer'), 'tree:' + !!t.closest('rb-trace-tree'), 'item:' + (t.closest('rb-object-item')?.getAttribute('ref') || 'none'));
}, true);
