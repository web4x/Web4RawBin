...
export const MODEL_DECLS: ActionDecl[] = [
  // T37.21 defect-2 (Tron DRY: "it cannot be that folders SOMETIMES have Add folder buttons"): 'add-folder' MOVED to
  // UNIVERSAL_DECLS (action-applicability.ts) so the offer follows the unit onto EVERY folder-like surface (model + room
  // Files), dispatched at ONE point by provenance. It MUST NOT live here — the folder-verb lint (check-folder-verb-single-source.mjs) REDs on it.
