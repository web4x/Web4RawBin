...
export const TRACE_ICONS: Record<string, string> = {
  ...
  // Sprint 41 T41.1 inc-4b: the 'file' type-icon derivation was DELETED here — a File now renders ITSELF via
  // File.renderSelf() → FILE_TOKEN_ICONS (below). No dormant duplicate (PO no-half-state). Other types unchanged.
