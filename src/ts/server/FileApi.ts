...
const TEXT_EXTS = new Set(['.md', '.ts', '.js', '.json', '.css', '.html', '.sh', '.puml', '.svg', '.env', '.txt', '.yml', '.yaml', '.toml', '.xml', '.mjs', '.cjs', '.mts', '.cts', '.tsx', '.jsx', '.map', '.lock', '.cfg', '.conf', '.ini', '.log', '.gitignore', '.editorconfig']);
