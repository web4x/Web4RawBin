...
**UseCases:**
- [🔗 selectionModel.singleton](../usecase/selectionmodel-singleton.md)
- [🔗 selectionModel.emptyShowsChat](../usecase/selectionmodel-emptyshowschat.md)
- [🔗 objectItem.tapSingleSelect](../usecase/objectitem-tapsingleselect.md)
- [🔗 objectItem.longPressMultiSelect](../usecase/objectitem-longpressmultiselect.md)
- [🔗 objectItem.selectedCSS](../usecase/objectitem-selectedcss.md)
- [🔗 objectItem.dragAllSelected](../usecase/objectitem-dragallselected.md)
- [🔗 drawer.selectionDriven](../usecase/drawer-selectiondriven.md)
- [🔗 drawer.removeDefaultHighlight](../usecase/drawer-removedefaulthighlight.md)
