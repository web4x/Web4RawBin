...
- [ ] [📝 R20.6 — SelectionModel (COMPOUND: 8 atomics a-h, ONE release)](../../../scenario/index/7/0/4/7/d/7047d04f-3226-46ff-a058-39f53f9aed58.scenario.json) — task `7047d04f`. **Release → v0.6.7 + tag** (after BUG1). App-wide SelectionModel singleton + selection-driven chat/details drawer, tap single-select, long-press multi-select, selected CSS, drag-all-selected, drawer consolidation, default-drawer cleanup. coveredRequirements = all 8 (R20.6a-h); each atomic carries its own intendedChain + RED. Architect designs the SelectionModel class.
