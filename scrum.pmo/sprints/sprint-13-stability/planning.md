...
- [ ] ⏳ [T142: Upload-vCard onboarding gate — speed up first-time profile fill](./task-142-upload-vcard-onboarding.md)
- [ ] ✅ [T91: Avatar Persistence — Must Not Revert to Default](./task-91-avatar-persist.md)
- [ ] ✅ [T92: Avatar Upload — Never Expose Key Errors to User](./task-92-avatar-upload-ux.md)
- [ ] ✅ [T93: All User Rooms Load from Disk and Appear in Lobby](./task-93-multi-room-lobby.md)
- [ ] ✅ [T94: PWA Update Banner Not Appearing (PRIORITY)](./task-94-pwa-update-banner.md)
