...
Current issue: `sprint status sprint-04-traceability` returns 0 tasks. The grep pattern for Status doesn't match `**Status:**` markdown bold format. Fix the pattern to handle both:
