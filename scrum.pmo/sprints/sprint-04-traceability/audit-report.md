...
Both in `sprint-01-rawbin-foundation/task-1-team-bootstrap.md`:
...
- `sprint-03-e2e-hardening/task-22-lobby-fixes.md` — has Status: DONE but no acceptance criteria section at all.
