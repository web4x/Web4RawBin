...
Meta: in ONE day the class caught 3 measured artifacts + a circular ruling + a stale mental read + the architect + the PO. That pervasiveness IS the argument for a by-construction cure over daily instance-fixes.
