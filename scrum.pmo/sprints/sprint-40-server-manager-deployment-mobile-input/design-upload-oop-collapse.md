...
## ★★ DEPLOY ORDER — capture LIVE + VERIFIED before SLICE-A (PO, evidence-critical; do NOT reorder)
BUILD is parallel (SLICE-A's correctness is quirk-independent). **DEPLOY is SEQUENTIAL:**
