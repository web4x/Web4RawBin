...
| 18 | Chain method-scope & role skills | planned — DOGFOOD: Sprint+Task units born as scenario.json FIRST (T188); chain-narrowing at Class→Method via UC.method singular IOR (T187); role SKILL.md co-spec from precedence Rules 1-11 (T189); tree lazy-RENDER + scroll-preservation (T190 — R18.5 expand-appends-children Tron 2026-06-05). JOINT architect+req+planner. | 4 + sub | [planning](./sprint-18-chain-method-scope/planning.md) |
