...
| 18 | Chain method-scope & role skills | active — DOGFOOD: T187 🔧 FIX-CYCLE (v0.5.88 shipped, tester STRICT TS5+TS7+TS2/8 FAIL, expert v0.5.89 fix shipped, tester RE-RUN pending); T190 🔧 FIX-CYCLE (v0.5.88 shipped, tester STRICT TS2 FAIL, expert v0.5.89 fix shipped, tester RE-RUN pending); T188 ⏳ (ViewGenerator); T189 ⏳ (architect+req SKILL.md pending). PO honest-board 2026-06-05: ✅-code ≠ strict-verified; symbols stay 🔧 until tester re-runs CLEAN. | 4 + sub | [planning](./sprint-18-chain-method-scope/planning.md) |
