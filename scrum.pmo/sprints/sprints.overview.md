...
| 18 | Chain method-scope & role skills | active — DOGFOOD: T187 ✅ shipped v0.5.88 (chain-narrowing + Sprint nav roots + `/api/trace/sprints`); T190 ✅ shipped v0.5.88 (lazy-render + scroll preservation); T188 ⏳ (ViewGenerator runnable bootstrap); T189 ⏳ (role SKILL.md trio — planner extended, architect+req pending). 4-role complete on T187/T190. JOINT architect+req+planner. | 4 + sub | [planning](./sprint-18-chain-method-scope/planning.md) |
