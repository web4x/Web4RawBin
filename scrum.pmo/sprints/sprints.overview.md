...
| 30 | Agent Messaging (Async Mailbox) | scenario-first stand-up 2026-07-02 (robbin-req): TRON-AUTHORIZED (R29.4 record). Sprint 2173e549 + R30.1-4 (AgentMessage unit / async mailbox / no-live-injection / Task.messages+skill-verbs) from skill-expert design 4546a59d9. Structural fix for sent-!=-delivered. | 4 | [planning](./sprint-30-agent-messaging/planning.md) |
