...
| 16 | Traceability UX & DetailViews | active — Phase 1-3 all 8 impl-shipped (T110-117, v0.5.23+bdb74ec STATIC_SHELL); Phase 4 planned (T120 black-bg, T121 chain-data fix — Tron 2026-05-29) | 10 | [planning](./sprint-16-traceability-ux/planning.md) |

**Task numbering:** global sequential. T1-T80 (S1-9), T81-83 (S10), T84 (S12),
T85-90 (S11), T91-95 (S13), T96-99 (S14), T100 (S13), T101-108 (S15), T109 (S13), T110-117 (S16), T118 (S13), T119 (S11), T120-121 (S16). Next new task = **T122**.
