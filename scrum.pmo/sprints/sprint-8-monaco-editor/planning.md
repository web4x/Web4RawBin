...
- [ ] [T60: FileApi.ts — readDir + readFile + sanitize + authorize](./task-60-fileapi-read.md)
  **Effort:** 2h expert + 1h tester
  - sanitizePath, authorize, readDir, readFile

- [ ] [T61: FileApi.ts — writeFile with mtime conflict](./task-61-fileapi-write.md)
  **Effort:** 1.5h expert + 1h tester
  - writeFile, mtime conflict detection (409), max 1MB

- [ ] [T62: FileApi vitest security tests](./task-62-fileapi-tests.md)
  **Effort:** 1h tester
  - Path traversal, blocked dirs, mtime conflict, auth

### Phase 2: Editor Shell + Monaco (read-only)

- [ ] [T63: edit.html + edit.ts + edit.css + CDN Monaco](./task-63-editor-entry.md)
  **Effort:** 2h expert
  - New entry point, CDN loading, build.mjs second bundle

- [ ] [T64: rb-editor-layout — three-panel layout](./task-64-editor-layout.md)
  **Effort:** 1.5h expert
  - Tree + editor + preview panels, draggable dividers

- [ ] [T65: rb-file-tree — directory browser](./task-65-file-tree.md)
  **Effort:** 2h expert
  - Lazy-load dirs, expand/collapse, file icons, active highlight

- [ ] [T66: rb-code-editor — Monaco wrapper](./task-66-code-editor.md)
  **Effort:** 2h expert + 0.5h tester
  - loadFile(), language detection, syntax highlighting

### Phase 3: Save + Preview

- [ ] [T67: rb-code-editor save — Cmd+S + dirty + conflict](./task-67-editor-save.md)
  **Effort:** 1.5h expert + 0.5h tester
  - Save, dirty tracking, conflict dialog

- [ ] [T68: rb-preview markdown — live preview](./task-68-preview-markdown.md)
  **Effort:** 1.5h expert + 0.5h tester
  - marked.js, debounced 300ms, link rewriting

- [ ] [T69: rb-preview PlantUML — SVG preview](./task-69-preview-puml.md)
  **Effort:** 1h expert + 0.5h tester
  - POST /api/puml-render, update on save

- [ ] [T70: rb-editor-toolbar — save, view toggle, breadcrumb](./task-70-editor-toolbar.md)
  **Effort:** 1h expert
  - Save button, split/code/preview toggle, file path

### Phase 4: Polish + Mobile

- [ ] [T71: Mobile layout — single-panel + tab bar](./task-71-mobile-layout.md)
  **Effort:** 1h expert + 0.5h tester
  - Viewport < 768px, Tree/Editor/Preview tabs

- [ ] [T72: Cross-links — /md/ ↔ /edit/](./task-72-cross-links.md)
  **Effort:** 0.5h expert
  - Edit button on /md/ pages, View button in editor

- [ ] [T73: Playwright E2E for editor](./task-73-editor-e2e.md)
  **Effort:** 2h tester
...
## Definition of Done
- [ ] /edit route loads Monaco editor
- [ ] File browser shows project tree
- [ ] Open, edit, save files to disk with conflict detection
- [ ] Markdown live preview
- [ ] PlantUML SVG preview on save
- [ ] Mobile layout works
- [ ] /md/ pages link to /edit/
- [ ] Path traversal + security tests pass
- [ ] No regression in Sprint 1-7
