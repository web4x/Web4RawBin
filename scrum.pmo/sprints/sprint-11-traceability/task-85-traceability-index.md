...
# T85: Traceability Index — Map All 89 Tasks to Chain Coverage
...
- down
  - None (atomic task)
- follows
  - [T84](./task-84-adopt-template.md) — uses the adopted standard's chain definition
...
living matrix that drives batch ordering for T86-T88.
...
- [ ] Batch order recommendation for T86-T88

## Dependencies
- **Requires:** T84 (chain definition)
- **Enables:** T86, T87, T88 (batches consume the matrix)
