...
- [x] [Task 30.41: 3-way merge editor shows per-filetype syntax highlighting](./task-30.41-per-filetype-syntax-highlight.md)
...
- [x] [Task 30.53: Changes-focused code-folding via NATIVE Monaco collapse/expand (fold by method boundaries)](./task-30.53-native-monaco-code-folding.md)
