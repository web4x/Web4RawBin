...
- [ ] [Task 30.6.1: 3-way diff/merge view](./task-30.6.1-3way-view.md)
- [ ] [Task 30.6.2: File selectors (reuse RbFileTree)](./task-30.6.2-file-selectors.md)
- [ ] [Task 30.6.3: Per-hunk take-over](./task-30.6.3-hunk-takeover.md)
- [ ] [Task 30.6.4: Git ref chooser](./task-30.6.4-git-chooser.md)
- [ ] [Task 30.6.5: Swap sides](./task-30.6.5-swap.md)
