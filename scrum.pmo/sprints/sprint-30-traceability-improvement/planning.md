...
- [ ] [Task 30.10: Right pane defaults to the files git history](./task-30.10-right-git-history-default.md)
- [ ] [Task 30.11: Scoreboard measures the walked chain](./task-30.11-scoreboard-walked-chain.md)
- [ ] [Task 30.12: 2-way take-over (no-base fallback)](./task-30.12-2way-takeover.md)
- [ ] [Task 30.13: IntelliJ inter-pane merge gutters + connectors](./task-30.13-gutters-connectors.md)
- [ ] [Task 30.14: Service-Worker auto-update (visible deploys)](./task-30.14-sw-auto-update.md)
- [ ] [Task 30.15: Right-history default meaningful + usable](./task-30.15-right-history-usable.md)
- [ ] [Task 30.16: IntelliJ 3-pane line alignment + center](./task-30.16-3pane-alignment.md)
- [ ] [Task 30.17: 3-pane merge functional correctness](./task-30.17-merge-correctness.md)
