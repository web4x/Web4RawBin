...
- [ ] ⏳ [Task 37.20.6: DEVICE @390 — Tron verifies on phone: file drags as file, every drop carries the unit, details render — [R37.20 AC-6-DEVICE]](./task-37.20.6-device-390-tron-acceptance.md)
...
- [ ] ⏳ [Task 37.35: AXIS-2 lint — task<->req AC PARITY (task-md AC set == covered-req AC set, count+ids) [R37.34; seeds T37.20 6-vs-7 RED]](./task-37.35-axis2-task-req-ac-parity-lint.md)
- [ ] ⏳ [Task 37.36: AXIS-3 lint — QA-is-a-SWITCH-STATE validity (every QA item names a waiting-on + switch-direction; evidence-invalidated => not-QA) [R37.34; seeds T40.85 RED]](./task-37.36-axis3-qa-switch-state-validity-lint.md)
- [ ] ⏳ [Task 37.37: AXIS-4 lint — drift-metric COMPLETENESS (excluded + checked == total; silent frozen-legacy / missing-file exclusion => RED) [R37.34; seeds 7-vs-200 RED]](./task-37.37-axis4-metric-completeness-lint.md)
- [ ] ⏳ [Task 37.38: Coordination-root parent renders a ROLLED summary of children (weakest-link + per-child mini-state), not its empty checklist [R37.35, AXIS-3 RENDER-half]](./task-37.38-parent-rolled-summary-render.md)
...
- [ ] 📝 [Task 37.34: Dir-namespace single base-resolution — ONE resolveDirRefAbs, all dir: refs repo-relative, retire the 2 correct-by-incident special-cases (gated both-directions migration) [covers R37.33]](./task-37.34-dir-namespace-single-resolver.md)
