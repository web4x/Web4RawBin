...
# T36: Offline Data Persistence

[task:uuid:a6ab0ca4-e972-4ee4-b287-1e59ed82134b]
...
## Task Description
- PO: IndexedDB for message queue, cached room state, background sync API, profile data in IndexedDB.
