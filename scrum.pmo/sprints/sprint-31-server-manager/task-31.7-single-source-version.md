...
- [x] **(config)** The app version lives in ONE typed scenario unit (ior:class:Config, schema-typed version field) = THE single source of truth. No other location holds an authored version; every other occurrence is derived.
